...
# ─────────────────────────────────────────────────────────────────────────
# 2. Sync the fork to the matching branch
# ─────────────────────────────────────────────────────────────────────────
echo "[2/6] git: syncing $FORK_DIR to branch=$MODE"
cd "$FORK_DIR"

git fetch origin --quiet
git checkout "$MODE" --quiet
git pull origin "$MODE" --quiet

CURRENT_SHA=$(git rev-parse --short HEAD)
echo "       on branch=$MODE at $CURRENT_SHA"

# ─────────────────────────────────────────────────────────────────────────
# 3. Source config from this branch
# ─────────────────────────────────────────────────────────────────────────
